...
<c:set var="context" value="${pageContext.request.contextPath}" />
	...
	<div class="container">
		<form class="form-horizontal" role="form" action="${context}/admin/faculty/edit" method="get">
			<h2>Faculty Details</h2>
			<div class="form-group">
				<label for="from" class="col-sm-3 control-label">ID: </label>
				<div class="col-sm-9">
					<label for="from" style="padding-top: 7px; font-weight: 100">${faculty.id}</label>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<label for="from" style="padding-top: 7px; font-weight: 100">${faculty.username}</label>
				</div>
			</div>
			<div class="form-group">
				<label for="from" class="col-sm-3 control-label">Description: </label>
				<div class="col-sm-9">
					<label for="from" style="padding-top: 7px; font-weight: 100">${faculty.description}</label>
				</div>
			</div>
			<div class="form-group">
